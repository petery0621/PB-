...
public class QuestionEntry{
	String text; 
	String type; // FIXME considering change to Integer


	// constructors
	QuestionEntry(){
	}
	QuestionEntry(String text){
		this.text = text; 
	}
...
//		sliderValue.text = "0"; 
	...
	void part_a_fix(){
		...
		// SYMPTOMS uppercases
		// SYMPTOMS underlined
		// header repeated every 3 symptom questions
		...
		string howBother = "How much did this bother you or distress you?"; //FIXME don't know what it's for
